public class PercolationStats {
    ...
    public PercolationStats(int N, int T){
        ...
        if (N <= 0 || T <= 0){
            throw new java.lang.IllegalArgumentException("Negative or zero input not allowed");
        }
    ...
    public static void main(String[] args){
        ...
        System.out.println("mean                    = " + String.valueOf(ps.mean()));
        System.out.println("stddev                  = " + String.valueOf(ps.stddev()));
        System.out.println("95% confidence interval = " + String.valueOf(ps.confidenceLo()) + ", " + String.valueOf(ps.confidenceHi()));
    }
}